...
public class WritableExpressionValue extends ObjectPropertyBase<Object> {
    ...
    public WritableExpressionValue(Object namespace, Expression expression, Class<?> type) {
        if (namespace == null) {
    ...
    @Override
    public Object get() {
        return BeanAdapter.coerce(expression.evaluate(namespace, false), type);
    }

    @Override
    public void set(Object newValue) {
        Object oldValue = super.get();
        if (oldValue != newValue) {
            expression.update(namespace, newValue);
            super.set(newValue);
        }
    }
