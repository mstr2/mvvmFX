 ...
 */
public class FXMLLoaderHelper11 {
    ...
    private FXMLLoaderHelper11() {
    }

    public static void setStaticLoad(FXMLLoader11 fxmlLoader, boolean staticLoad) {
    ...
    public interface FXMLLoaderAccessor {
        void setStaticLoad(FXMLLoader11 fxmlLoader, boolean staticLoad);
    }
}