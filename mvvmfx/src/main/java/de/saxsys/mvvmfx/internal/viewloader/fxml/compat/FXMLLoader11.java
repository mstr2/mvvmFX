...
package de.saxsys.mvvmfx.internal.viewloader.fxml.compat;
 ...
 * @since JavaFX 2.0
 */
public class FXMLLoader11 implements FXMLLoaderImpl {
            ...
            if (aValue.startsWith(ESCAPE_PREFIX)) {
                ...
                if (aValue.startsWith(RELATIVE_PATH_PREFIX)) {
                    ...
                    if (aValue.charAt(0) == '/') {
                        ...
                        try {
                            return new URL(FXMLLoader11.this.location, aValue).toString();
                        } catch (MalformedURLException e) {
                            System.err.println(FXMLLoader11.this.location + "/" + aValue);
                        }
                    }
                }
    ...
    private class IncludeElement extends ValueElement {
        ...
        public ResourceBundle resources = FXMLLoader11.this.resources;
        public Charset charset = FXMLLoader11.this.charset;
            ...
            if (prefix == null) {
                if (localName.equals(INCLUDE_SOURCE_ATTRIBUTE)) {
                    ...
                    resources = ResourceBundle.getBundle(value, Locale.getDefault(),
                            FXMLLoader11.this.resources.getClass().getClassLoader());
    ...
    static {
        ...
        FXMLLoaderHelper11.setFXMLLoaderAccessor(new FXMLLoaderHelper11.FXMLLoaderAccessor() {
            @Override
            public void setStaticLoad(FXMLLoader11 fxmlLoader, boolean staticLoad) {
                fxmlLoader.setStaticLoad(staticLoad);
            }
        });
    }
    ...
    /**
     * Creates a new FXMLLoader11 instance.
     */
    public FXMLLoader11() {
        this((URL)null);
    }
     ...
     * @since JavaFX 2.1
     */
    public FXMLLoader11(URL location) {
        this(location, null);
    }
     ...
     * @since JavaFX 2.1
     */
    public FXMLLoader11(URL location, ResourceBundle resources) {
     ...
     * @since JavaFX 2.1
     */
    public FXMLLoader11(URL location, ResourceBundle resources, BuilderFactory builderFactory) {
     ...
     */
    public FXMLLoader11(Charset charset) {
    ...
    public FXMLLoader11(InputStream inputStream, URL location, ResourceBundle resources, BuilderFactory builderFactory,
            Callback<Class<?>, Object> controllerFactory, Charset charset,
            LinkedList<FXMLLoaderImpl> loaders) {
        setLocation(location);
        setResources(resources);
    ...
    public boolean equals(Object obj) {
        if (obj instanceof FXMLLoader11) {
            FXMLLoader11 loader = (FXMLLoader11)obj;
    ...
    private static boolean needsClassLoaderPermissionCheck(Class caller) {
        ...
        return !FXMLLoader11.class.getModule().equals(caller.getModule());
    }
    ...
    public static void setDefaultClassLoader(ClassLoader defaultClassLoader) {
        ...
        FXMLLoader11.defaultClassLoader = defaultClassLoader;
    }
    ...
    private static <T> T loadImpl(URL location, ResourceBundle resources,
        ...
        FXMLLoader11 fxmlLoader =
                new FXMLLoader11(location, resources, builderFactory,
